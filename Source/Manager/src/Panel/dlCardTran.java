...
public class dlCardTran extends javax.swing.JDialog {

    DefaultTableModel table;
    TableRowSorter<TableModel> sorter;
    tbTransaction cus = new tbTransaction();
    
    public dlCardTran(java.awt.Frame parent, boolean modal, int cardid) {
        super(parent, modal);
        initComponents();
        
        table = (DefaultTableModel) grTran.getModel();
        sorter = (TableRowSorter<TableModel>) grTran.getRowSorter();
        for (tbTransaction item : cus.getTransactionBYCardID(cardid)) {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(728, 411));
        ...
        jLabel1.setText("CARD TRANSACTION");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("List Card Of Client"));
