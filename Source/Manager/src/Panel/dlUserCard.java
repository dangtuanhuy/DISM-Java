...
public class dlUserCard extends javax.swing.JDialog {

    DefaultTableModel table;
    tbATMCard cus;
    public dlUserCard(java.awt.Frame parent, boolean modal, int khid) {
        super(parent, modal);
        initComponents();
        table = (DefaultTableModel) grCard.getModel();
        cus = new tbATMCard();
        for (tbATMCard item : cus.getListByKHID(khid)) {
            table.addRow(item.toCardVector());
        }
    }
