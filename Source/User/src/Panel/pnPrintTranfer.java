...
public class pnPrintTranfer extends javax.swing.JPanel {
    ...
    public pnPrintTranfer(Run run, boolean lang, int atm, int card, int giaodich) {
        initComponents();
        this.run = run;
        this.atm = atm;
        this.card = card;
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
            ...
            try {
                ...
                JasperPrint jasperPrint = JasperFillManager.fillReport(new File("").getAbsolutePath() + "\\Report\\Tranfer.jasper", params, n);
